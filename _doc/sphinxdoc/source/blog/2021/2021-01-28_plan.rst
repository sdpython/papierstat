...
.. blogpost::
    ...
    * `Web-Scraping <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/TD2A_Eco_Web_Scraping.html>`_,
      `Web-Scraping (correction) <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/TD2A_Eco_Web_Scraping_corrige.html>`_,
      `Scraping, récupérer une image depuis LeMonde <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/2018-10-02_scraping_recuperer_images.html>`_
    * cache, javascript
    * blacklist
    ...
    * `API REST <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/TD2A_eco_les_API.html>`_,
      `API REST SNCF <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/TD2A_eco_API_SNCF.html>`_,
      `API REST SNCF (corrigé) <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/TD2A_eco_API_SNCF_corrige.html>`_
    * `Créer sa propre API REST <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/2020_rest.html>`_
    ...
    * `Introduction au text mining <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/td2a_eco_NLP_tf_idf_ngrams_LDA_word2vec_sur_des_extraits_litteraires.html>`_
    * `Analyse de sentiments <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/td2a_sentiment_analysis.html>`_,
      `Analyse de sentiments - correction <http://www.xavierdupre.fr/app/ensae_teaching_cs/helpsphinx3/notebooks/td2a_sentiment_analysis_correction.html>`_
