...
set_sphinx_variables(__file__, "papierstat", "Xavier Dupré", 2023,
...
epkg_dictionary.update({
    ...
    'fbprophet': 'https://github.com/facebook/prophet/tree/master/python',
    ...
    'teachpyx': "http://www.xavierdupre.fr/app/teachpyx/helpsphinx/index.html",
