...
pour un événement jamais observé. Ces trechniques
synthétise les observations passées pour en déduire
...
Le machine learning propose une façon de construire
une fonction qui résume ou modèlise les observations passées.
Le résultat obtenu fait une synthèse du passé pour
